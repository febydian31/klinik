...
<script src="<?php echo base_url(); ?>assets/admin/assets/vendor/jquery/dist/jquery.min.js"></script>
  ...
  <!-- Optional JS -->
  <script src="<?php echo base_url(); ?>assets/admin/assets/vendor/chart.js/dist/Chart.min.js"></script>
  <script src="<?php echo base_url(); ?>assets/admin/assets/vendor/chart.js/dist/Chart.extension.js"></script>
  <!-- Argon JS -->
